...
- `BT` API name or bootstrap usage changes: review kit `content/docs/*.md` and the kit rule sources
  `content/rules/blit-api-names.md` / `blit-integer-coords.md`.
...
- blit-tech public API changes (sibling repo): audit kit docs and `content/rules/blit-api-names.md`.
