...
- `blit run` - the same thing, the friendly way.
...
## A note on AI-assistant files

This project ships this `AGENTS.md` and the `docs/` folder as plain, readable guidance. Editor-specific setup (Claude,
Cursor, Zed, and others) is generated by `blit agents` in a later version of Blit-Tech. Today, point your assistant at
this file.
